...
const EXTRACTION_TERMS = {
  ...
  commercial_offers: ["paid beta", "design partner", "package", "offer", "trial", "demo", "subscription", "workspace", "platform", "consulting", "workshop", "onboarding"],
...
const EXTRACTORS = {
  ...
  messaging: {
    "Revenue cognition readout": ["revenue cognition", "cognix readout", "leadership decision", "revenue risk"],
  ...
  positioning: {
    "Revenue cognition system": ["revenue cognition", "cognition system", "strategic coherence"],
    "GTM readout workflow": ["readout", "evidence trail", "leadership decision"],
    "GTM cognition layer": ["cognition", "interpretation layer", "ontology", "relational intelligence"],
  ...
  launch: {
    ...
    "Diagnostic Studio beta": ["beta", "design partner", "diagnostic studio"]
  },
  enablement_theme: {
  ...
  commercial_offer: {
    "Paid beta design partner": ["paid beta", "design partner", "founder-led onboarding"],
    "Diagnostic workspace": ["diagnostic workspace", "studio", "workspace"],
    "Consulting engagement": ["workshop", "advisory", "consulting", "consultancy"]
  },
  strategic_goal: {
    "Create a new category": ["category", "category-defining", "continuous gtm cognition"],
    "Prevent pipeline loss": ["pipeline loss", "conversion", "pipeline risk"],
    "Unify GTM interpretation": ["shared view", "interpretation", "coherence"]
  }
};
...
function detectOntologyContradictions(ontology, relationships, bundle) {
  ...
  addConflict(contradictions, byType.positioning, "Positioning fragmentation", "Multiple positioning systems are active at once, creating uncertainty about whether the company is a revenue cognition system, readout workflow, reporting aid, or software product.", "High");
...
function buildTemporalCognition(bundle, ontology, contradictions, previousMemory) {
  ...
  return {
    ...
    memory_state: previousMemory.length
      ...
      : "This is the first memory snapshot; temporal cognition will deepen as future runs accumulate."
  };
}
...
function simulateScenarios(causalModel, narrativeGravity, pressureModel, propagation) {
  ...
  return [
    {
      scenario: "Reposition around active strategic cognition",
...
function interventionFor(title) {
  ...
  return "Resolve the contradiction using the cited source signals and rerun cognition.";
}
