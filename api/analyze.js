...
async function runOpenAIDiagnostic(project, signals) {
  ...
  const prompt = [
    ...
    JSON.stringify({
      ...
      contradictions: [{
        title: "plain PMM fracture title",
        severity: "High | Medium | Low",
        gtm_fracture: "plain-language contradiction",
        conflicting_nodes: ["Launch goal vs CTA | ICP vs proof | Buyer pain vs positioning | Sales objections vs homepage story | Campaign promise vs product proof | Founder narrative vs field narrative | Launch goal vs enablement story"],
        receipts: ["exact submitted evidence"],
        where_the_story_breaks: "landing page | campaign | sales narrative | demand gen | executive story | enablement | founder narrative | launch goal",
        who_feels_it: "PMM | Sales | Demand Gen | Founder/CEO | RevOps | CS | Enablement | Exec team",
        commercial_risk: "pipeline waste | weak conversion | poor sales follow-up | confused buyer | low demo intent | wasted launch budget | field inconsistency | delayed revenue signal",
        pmm_fix_path: "specific PMM action",
      ...
      top_diagnosis: "specific cross-GTM fracture, not a single-asset critique",
    ...
    "Cognix is a GTM fracture detection system for PMMs. Do not critique one asset in isolation.",
    "Every major diagnosis must compare at least two GTM nodes: Launch goal vs CTA, ICP vs proof points, buyer pain vs positioning, sales objections vs homepage story, campaign promise vs product proof, founder narrative vs field narrative, or launch goal vs enablement story.",
    "Use this structure for major findings: GTM fracture, receipts, where the story breaks, who feels it, commercial risk, PMM fix path.",
    "Receipts must quote exact submitted language when available. Do not invent evidence.",
    "Do not return isolated asset advice unless the finding names the conflicting GTM nodes and business consequence.",
    "Flag broad AI language only when it conflicts with buyer pain, proof, sales objections, ICP, CTA, or launch goal.",
    "Use PMM-native language. Avoid academic or infrastructure jargon.",
    "Why not ChatGPT: ChatGPT can critique a page; Cognix compares launch goal, ICP, buyer pain, positioning, proof, objections, CTA, and sales narrative to find contradictions with receipts.",
